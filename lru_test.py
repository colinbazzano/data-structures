...
# DEFAULTS to False. When True, will print Cached list per each result, and show in test file
LRUCache.DEBUG = True
# when result is cached etc... used for debugging/testing purposes only.

# DEFAULTS to None. If None...There is no limit to the cache list. Setting to 3 in test file..
